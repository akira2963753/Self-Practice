...
#------------------------- Create Clock --------------------------
#=================================================================
create_clock -name sclk -period $CYCLE1 [get_ports sclk]
create_clock -name dclk -period $CYCLE2 [get_ports dclk]
...
set_input_delay [expr $CYCLE1 * 0.5] -clock sclk [remove_from_collection [all_inputs] [get_ports dbusy]]
set_input_delay [expr $CYCLE2 * 0.5] -clock dclk [get_ports dbusy]

# Output Delay Constraints
set_output_delay [expr $CYCLE1 * 0.5] -clock sclk [get_ports sready]
set_output_delay [expr $CYCLE2 * 0.5] -clock dclk [get_ports {dout dvalid}]
